...
export const MAKERS = {
    ...
    bedroll: makeBedroll,
    bellows: makeBellows,
    'bird-bath': makeBirdBath,
    bone: makeBone,
    'bone-pile': makeBonePile,
    bookshelf: makeBookshelf,
    boots: makeBoots,
    boulder: makeBoulder,
    broom: makeBroom,
    'broken-stool': makeBrokenStool,
    bucket: makeBucket,
    bunk: makeBunk,
    cabinet: makeCabinet,
    candelabra: makeCandelabra,
    'candle-cluster': makeCandleCluster,
    'chained-bucket': makeChainedBucket,
    'chamber-pot': makeChamberPot,
    chair: makeChair,
    cistern: makeCistern,
    'clothes-pile': makeClothesPile,
    'coal-heap': makeCoalHeap,
    'coffin-fragment': makeCoffinFragment,
    crate: makeCrate,
    crocks: makeCrocks,
    'crystal-shard': makeCrystalShard,
    'cutting-board': makeCuttingBoard,
    'debris-pile': makeDebrisPile,
    desk: makeDesk,
    'dining-table': makeDiningTable,
    'drip-pipe': makeDripPipe,
    'fallen-book': makeFallenBook,
    'floor-lantern': makeFloorLantern,
    'floor-shield': makeFloorShield,
    'flower-crate': makeFlowerCrate,
    'folded-linens': makeFoldedLinens,
    goblet: makeGoblet,
    'gold-urn': makeGoldUrn,
    'grain-sack': makeGrainSack,
    'grate-cover': makeGrateCover,
    'hanging-chain': makeHangingChain,
    'hanging-ham': makeHangingHam,
    'hat-box': makeHatBox,
    helm: makeHelm,
    'holy-plaque': makeHolyPlaque,
    incense: makeIncense,
    ingot: makeIngot,
    'ink-quill': makeInkQuill,
    kettle: makeKettle,
    'kneeling-cushion': makeKneelingCushion,
    lectern: makeLectern,
    'melted-candles': makeMeltedCandles,
    'moss-tuft': makeMossTuft,
    mushroom: makeMushroom,
    nest: makeNest,
    'nightstand-candle': makeNightstandCandle,
    'offering-bowl': makeOfferingBowl,
    'overturned-pot': makeOverturnedPot,
    painting: makePainting,
    'pebble-cluster': makePebbleCluster,
    pew: makePew,
    'place-setting': makePlaceSetting,
    plant: makePlant,
    planter: makePlanter,
    platter: makePlatter,
    'rope-coil': makeRopeCoil,
    rug: makeRug,
    sack: makeSack,
    sarcophagus: makeSarcophagus,
    'scroll-pile': makeScrollPile,
    shackles: makeShackles,
    shelf: makeShelf,
    'skull-stack': makeSkullStack,
    slag: makeSlag,
    'slime-bucket': makeSlimeBucket,
    'spear-stand': makeSpearStand,
    'stacked-bowls': makeStackedBowls,
    stalagmite: makeStalagmite,
    stove: makeStove,
    'straw-pile': makeStrawPile,
    table: makeTable,
    'tin-cup': makeTinCup,
    'tiny-globe': makeTinyGlobe,
    tongs: makeTongs,
    torch: makeTorch,
    urn: makeUrn,
    'velvet-stool': makeVelvetStool,
    washbasin: makeWashbasin,
    'watering-can': makeWateringCan,
    'weapon-rack': makeWeaponRack,
    weapons: makeWeapons,
    well: makeWell,
};

export const SCENE_MATS = {
    woodMat,
    ironMat,
    wallMat,
    crackedWallMat,
